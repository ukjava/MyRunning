...
public class WaveView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private int mCircleColor = Color.parseColor("#32000000");//背景内圆颜色
    private int mOutCircleColor = Color.parseColor("#32000000");//背景外圆颜色
    private int mWaveColor = Color.parseColor("#00FA9A");//水波颜色
    private int mWaterLevel;// 水目标高度
    //private int flowNum = 60;//水目标占百分比这里是整数。
    private String  flowNum  = "LV1";
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        mWaterLevel = (int) (2 * mRadius * 60 / 100f);//算出目标水位高度
