package com.ukjava.myrunning.step.view;
...
import com.ukjava.myrunning.step.DisplayUtils;
...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, context.getResources().getColor(R.color.pink));
        ...
        mProgessTextColor = a.getColor(R.styleable.CountDownView_progressTextColor, context.getResources().getColor(R.color.pink));
