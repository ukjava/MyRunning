package com.ukjava.myrunning.utils.animutils;
...
public class AnimationsContainer {
    public static int FPS;  // 每秒播放帧数，fps = 1/t，t-动画两帧时间间隔
    private static int resId; //图片资源
    ...
    //获取单例
    public static AnimationsContainer getInstance(int Id, int fps) {
        FPS = fps;
        resId = Id;
        if (mInstance == null)
    ...
    public class FramesSequenceAnimation {
        ...
        public  boolean mShouldRun; // 开始/停止播放用
